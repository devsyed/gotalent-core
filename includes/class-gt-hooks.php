...
class GTHooks
{
     ...
     * Priority: 10
     */
    public static function gt_send_new_invitation_email_to_talent_and_recruiter($talent_id, $booking_id, $recruiter_id)
    {
        $talent = get_user_by('id', $talent_id);
        $recruiter = get_user_by('id', $recruiter_id);
        $mail = GTMailer::gt_send_mail($talent->user_email, 'welcome@gotalent.com', 'GoTalent', 'New Invitation', 'emails/new-registration.php');
        $mail = GTMailer::gt_send_mail($recruiter->user_email, 'welcome@gotalent.com', 'GoTalent', 'Booking Invitation Sent', 'emails/new-registration.php');
        return;
    }
