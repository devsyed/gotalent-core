...
class PW_CMB2_Field_Taxonomy_Select2 {
	...
	public function render_pw_taxonomy_select( $field, $field_escaped_value, $field_object_id, $field_object_type, $field_type_object ) {
		...
		echo $field_type_object->select( array(
			...
			'options'          => "<option></option>".$this->get_pw_taxonomy_options( $field_type_object, $field_escaped_value ),
	...
	public function setup_admin_scripts() {
		...
		wp_enqueue_script( 'pw-taxonomy-select2-init', $asset_path . '/js/script.js', array( 'cmb2-scripts', 'wpfi-select2', 'jquery-ui-sortable' ), self::VERSION );
		wp_enqueue_style( 'pw-taxonomy-select2-tweaks', $asset_path . '/css/style.css', array( 'wpfi-select2' ), self::VERSION );
	}
