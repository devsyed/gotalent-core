...
<div class="group-category-job wow fadeInUp">
    <?php if($talent_categories): foreach($talent_categories as $category): ?>
        ...
        <div class="job-category-box clickable-div" data-link="<?php echo '/talent?cat_slug=' . $category->term_id; ?>">
            <div class="job-category-header">
            <h1>
                <a href="<?php echo '/talent?cat_slug=' . $category->term_id; ?>"><?php echo $category->name; ?></a></h1>
            </div>
